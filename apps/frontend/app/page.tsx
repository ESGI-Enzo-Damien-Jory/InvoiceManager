        ...
        <div className="flex flex-col min-h-svh bg-background">
            ...
            <header className="flex items-center justify-between px-6 py-4 border border-border bg-card shadow-sm rounded-lg mx-auto mt-6 w-full max-w-6xl">
                ...
                <nav className="flex gap-6 items-center text-sm font-medium">
                    ...
                    <Link href="/login">
                        <Button size="lg" className="px-6 ml-2">
                            Login
                        </Button>
                    </Link>
                </nav>
            ...
            <main className="flex-1 flex flex-col items-center px-4 py-16 relative w-full">
                ...
                <section className="w-full max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-12 mt-12 mb-24">
                    <div className="flex-1 flex flex-col items-start gap-6">
                        <h1 className="text-5xl font-extrabold bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent drop-shadow mb-2">
                            Invoice Management, Simplified
                        </h1>
                        <p className="text-lg text-muted-foreground max-w-xl mb-2">
                            InMa helps you manage your invoices, clients, and
                            business with ease. Create, send, and track invoices
                            in seconds. Stay organized and get paid faster.
                        </p>
                ...
                <section
                    id="features"
                    className="w-full max-w-6xl mx-auto grid gap-8 md:grid-cols-3 mb-24"
                >
                    <div className="bg-card rounded-lg p-8 shadow flex flex-col items-center border border-border">
                        ...
                        <p className="text-muted-foreground text-center">
                            Create and send professional invoices in just a few
                            clicks. Customize with your branding.
                        </p>
                    </div>
                    <div className="bg-card rounded-lg p-8 shadow flex flex-col items-center border border-border">
                        <span className="text-4xl mb-3">📊</span>
                        ...
                        <p className="text-muted-foreground text-center">
                            Track payments, monitor revenue, and get insights
                    ...
                    <div className="bg-card rounded-lg p-8 shadow flex flex-col items-center border border-border">
                        ...
                        <p className="text-muted-foreground text-center">
                            Your data is safe with us. We use modern security
                ...
                <section id="how" className="w-full max-w-4xl mx-auto mb-24">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="flex flex-col items-center">
                            <div className="bg-primary/10 text-primary rounded-full w-16 h-16 flex items-center justify-center text-3xl mb-4">
                                1
                            </div>
                            ...
                            <p className="text-muted-foreground text-center">
                                Sign up and set up your business profile in
                                seconds.
                            </p>
                        </div>
                        <div className="flex flex-col items-center">
                        ...
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-muted-foreground text-center">
                                Track payments and get notified when you’re
                                paid.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 justify-center">
                        <div className="flex-1 bg-card border border-border rounded-lg p-8 shadow flex flex-col items-center">
                            ...
                            <p className="text-muted-foreground mb-4">
                                All core features, unlimited invoices & clients.
                            </p>
                        ...
                        <div className="flex-1 bg-card border border-border rounded-lg p-8 shadow flex flex-col items-center opacity-60 cursor-not-allowed">
                            ...
                            <p className="text-muted-foreground mb-4">
                                Advanced analytics, custom branding, and more.
                            </p>
                            <div className="text-4xl font-extrabold mb-2">
                                $9
                    ...
                    <div className="grid gap-6">
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Yes! All core features are free. We plan to
                                offer a Pro plan with advanced features soon.
                            </p>
                        </div>
                        <div>
                            <h3 className="font-semibold mb-1">
                                Can I use InMa for multiple businesses?
                            </h3>
                            <p className="text-muted-foreground">
                                Currently, each account is tied to one business.
                                Multi-business support is on our roadmap.
                            </p>
                        </div>
                        <div>
                            <h3 className="font-semibold mb-1">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Absolutely. We use modern security practices and
